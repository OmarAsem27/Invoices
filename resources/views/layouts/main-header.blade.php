                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left">
                                    <form action="{{ route('read-all-notification') }}" method="post">
                                        @csrf
                        ...
                        <div class="main-notification-list Notification-scroll">
                                ...
                                <a class="d-flex p-3 border-bottom" href="#">
                                    ...
                                    <div class="mr-3">
                                        <h5 class="notification-label mb-1">
                                            {{ $notification->data['title'] }} : {{ auth()->user()->name }}
                                        </h5>
                            ...
                            {{-- <a class="d-flex p-3 border-bottom" href="#">
                                ...
                                <div class="mr-3">
                                    <h5 class="notification-label mb-1">تم اضافة فاتورة باسم : عمر عاصم</h5>
                                    <div class="notification-subtext">منذ عشر ساعات</div>
                                </div>
                                <div class="mr-auto">
                                    <i class="las la-angle-left text-left text-muted"></i>
                                </div>
